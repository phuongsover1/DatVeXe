...
<div class="container">
    <div class="d-flex justify-content-between my-4">
        <c:choose>
            <c:when test="${param.daThanhToanVaHuy}">
        ...
        <div>
            <a href="${pageContext.request.contextPath }/nhanvien/veChuaThanhToan?daThanhToanVaHuy=true"
    ...
    <!-- Thanh tìm kiếm -->
    <form class="row g-3" action="${pageContext.request.contextPath }/veXe/timKiemVeNV" method="GET">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success"
                           href="${pageContext.request.contextPath }/chiTietVe?veId=${veXe.idVe}">Chi tiết</a>
                    </td>
                </tr>
            </c:forEach>
