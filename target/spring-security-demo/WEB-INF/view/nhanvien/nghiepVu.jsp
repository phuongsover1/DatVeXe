...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-around">
        <a href="${pageContext.request.contextPath }/nhanvien/nghiepVu?themXeMoi=true" class="btn btn-primary"> Thêm Xe
            Mới</a>
        <a href="${pageContext.request.contextPath }/nhanvien/nghiepVu?themChuyenXeMoi=true" class="btn btn-primary">
            Thêm Chuyến Xe Mới</a>
        <a href="${pageContext.request.contextPath }/nhanvien/nghiepVu?danhDauXe=true" class="btn btn-primary"> Đánh Dấu
            Xe Đã Hoàn Thành Chuyến Xe</a>
    </div>
        ...
        <table class="table table-primary table-striped mt-4">
            ...
            <c:forEach items="${ listChuyenXeChuaHoanThanh}" var="chuyenXe">
                <tr>
                    ...
                    <td style="font-family: 'FontAwesome', 'Second Font name';">${chuyenXe.maTuyen.diaDiemDi.tenDiaDiem }
                        &#xf30b; ${chuyenXe.maTuyen.diaDiemDen.tenDiaDiem }</td>
                    ...
                    <td>
                        <form:form action="${pageContext.request.contextPath }/nhanvien/danhDauChuyenXe" method="POST">
                            <input type="hidden" name="idChuyenXe"
                                   value="${chuyenXe.maChuyen }"/> <!-- bỏ id chuyến xe vào đây -->
