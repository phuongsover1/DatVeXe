...
<!-- ///////////////////// Anh duoi nav-->
<img
        src="${pageContext.request.contextPath }/resources/img/duoi_nav.png"
        class="img-fluid" alt="">
<!-- /////////////////// Form dat ve -->
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2500"
                ...
                <img class="d-block w-100"
                     src="${pageContext.request.contextPath }/resources/img/pic1.jpg"
                     alt="First slide">
            </div>
            <div class="carousel-item" data-bs-interval="2500"
                 style="max-height: 240px;">
                <img class="d-block w-100"
                     src="${pageContext.request.contextPath }/resources/img/pic2.jpg"
                     alt="Second slide">
            </div>
            <div class="carousel-item" data-bs-interval="2500"
                 style="max-height: 240px;">
                <img class="d-block w-100"
                     src="${pageContext.request.contextPath }/resources/img/pic3.png"
                     alt="Third slide">
            </div>
        </div>
    </div>
    ...
    <div id="tuyenPhoBien" class="my-3">
        ...
        <ul class="row w-100 justify-content-center">
            <div class="col-lg-5">
                <a href="${pageContext.request.contextPath }/veXe/datVe/step1"
                   class="text-decoration-none">
                    <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                            class="col-4 p-0"
                            src="${pageContext.request.contextPath }/resources/img/tuyen_1.png"
                            class="img-fluid" alt="">
                ...
                <li class="row my-3 rounded-3 shadow-lg thanhChuyenXe"><img
                        class="col-4 p-0"
                        src="${pageContext.request.contextPath }/resources/img/tuyen_2.png"
                        class="img-fluid" alt="">
                    <div class="col-8 py-3">
                ...
                <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                        class="col-4 p-0"
                        src="${pageContext.request.contextPath }/resources/img/tuyen_3.png"
                        class="img-fluid" alt="">
                    <div class="col-8 py-3">
                ...
                <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                        class="col-4 p-0"
                        src="${pageContext.request.contextPath }/resources/img/tuyen_4.png"
                        class="img-fluid" alt="">
                    <div class="col-8 py-3">
            ...
            <div class="col-lg-5">
                <a href="${pageContext.request.contextPath }/veXe/datVe/step1"
                   class="text-decoration-none">
                    <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                            class="col-4 p-0"
                            src="${pageContext.request.contextPath }/resources/img/tuyen_5.png"
                            class="img-fluid" alt="">
                        <div class="col-8 py-3">
                ...
                <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                        class="col-4 p-0"
                        src="${pageContext.request.contextPath }/resources/img/tuyen_6.png"
                        class="img-fluid" alt="">
                    <div class="col-8 py-3">
                ...
                <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                        class="col-4 p-0"
                        src="${pageContext.request.contextPath }/resources/img/tuyen_7.png"
                        class="img-fluid" alt="">
                    <div class="col-8 py-3">
                ...
                <a href="${pageContext.request.contextPath }/veXe/datVe/step1"
                   class="text-decoration-none">
                    <li class="row my-3 rounded-3 shadow-lg  thanhChuyenXe"><img
                            ...
                            src="${pageContext.request.contextPath }/resources/img/tuyen_8.png"
                            class="img-fluid" alt="">
                        <div class="col-8 py-3">
